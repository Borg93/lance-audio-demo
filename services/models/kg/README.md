...
A `services/models/*` service isolated by **dependencies** (LightRAG's `pandas<2.4`
...
uv run --project services/models/kg python services/models/kg/build_kg.py \
...
uv run python services/models/kg/refine_person_types.py --db $DB
```
