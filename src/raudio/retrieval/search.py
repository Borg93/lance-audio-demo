...
by :func:`raudio.ingest.ingest.ingest_many` (and its single-doc wrapper
:func:`raudio.ingest.ingest.ingest_document`) at ingest time, or rebuilt
standalone via :func:`raudio.ingest.ingest.reindex_fts`.
"""
