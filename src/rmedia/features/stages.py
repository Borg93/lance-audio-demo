...
The core (:mod:`rmedia.core.registry`) defines what a Stage IS; this module
...
from rmedia.core.registry import AUDIO_VIDEO, VIDEO_ONLY, ActorConfig, Stage, StageShape

# Keys mirror rmedia.features.embed_columns CHUNK_KEYS/FRAME_KEYS.
