...
by :func:`rmedia.ingest.ingest.ingest_many` (and its single-doc wrapper
:func:`rmedia.ingest.ingest.ingest_document`) at ingest time, or rebuilt
standalone via :func:`rmedia.ingest.ingest.reindex_fts`.
"""
