"""Pure data-hygiene helpers in ``runners/kg/adapter.py``.
...
regression guard. ``runners/kg`` is a plain script dir (no __init__) — load by path.
"""
...
_SPEC = importlib.util.spec_from_file_location(
    "kg_adapter", Path(__file__).resolve().parent.parent / "runners" / "kg" / "adapter.py"
)
...
# --- generic-noun classifier (runners/kg/generic_sv.py), reached via adapter ---
