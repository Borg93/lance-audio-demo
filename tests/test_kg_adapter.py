"""Pure data-hygiene helpers in ``services/models/kg/adapter.py``.
...
regression guard. ``services/models/kg`` is a plain script dir (no __init__) — load by path.
"""
...
_SPEC = importlib.util.spec_from_file_location(
    "kg_adapter", Path(__file__).resolve().parent.parent / "services" / "models" / "kg" / "adapter.py"
)
...
# --- generic-noun classifier (services/models/kg/generic_sv.py), reached via adapter ---
