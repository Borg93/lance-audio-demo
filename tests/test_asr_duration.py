...
patch it AT THE SEAM -- ``raudio.asr.detect_language.read_audio_segment``, the
...
import raudio.asr.detect_language as detect_language
from raudio.asr.detect_language import _probe_duration_s
