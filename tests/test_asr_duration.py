...
patch it AT THE SEAM -- ``runners.asr.detect_language.read_audio_segment``, the
...
import numpy as np
import pytest
import runners.asr.detect_language as detect_language
from runners.asr.detect_language import _probe_duration_s
