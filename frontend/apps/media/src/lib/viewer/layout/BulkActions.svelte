...
<div class="flex flex-col gap-2 border-b border-border p-3" data-testid="bulk-actions">
  ...
  {#if controller.labelClasses.length}
    <div class="flex flex-wrap gap-1" title="Apply label to all selected">
      {#each controller.labelClasses as lc (lc)}
        <button
          class="rounded border border-border px-1.5 py-0.5 text-[11px] hover:bg-muted"
