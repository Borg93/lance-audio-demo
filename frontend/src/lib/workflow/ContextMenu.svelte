...
<div
  class="fixed z-50 min-w-[9rem] rounded-md border border-border bg-card p-1 text-xs text-foreground shadow-lg"
...
>
  ...
  {:else}
    <div class="px-2 py-1 text-[10px] tracking-wide text-muted-foreground uppercase">Add node</div>
