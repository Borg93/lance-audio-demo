  ...
  <div class="mx-auto max-w-3xl px-6 py-8">
      ...
      <section use:reveal class="reveal mb-10">
        ...
        <div class="flex flex-col items-center">
          <div class="grid w-full grid-cols-3 gap-2">
            <div
              class="bg-surface2 border-border border-l-[3px] border-l-sky-400 rounded-md border px-2 py-2 text-center text-xs"
            >
              ⌨️ Keyword text
            </div>
            <div
              class="bg-surface2 border-border border-l-[3px] border-l-primary rounded-md border px-2 py-2 text-center text-xs"
            >
              💬 Meaning text
            </div>
            <div
              class="bg-surface2 border-border border-l-[3px] border-l-amber-400 rounded-md border px-2 py-2 text-center text-xs"
            >
              🖼️ Image
            </div>
          </div>
    ...
    {:else}
      ...
      <div class="grid gap-3 sm:grid-cols-2">
        <div
          use:reveal
          class="reveal bg-surface2 border-border border-l-[3px] border-l-primary rounded-lg border p-3"
        >
        ...
        <div
          use:reveal={{ delay: 90 }}
          class="reveal bg-surface2 border-border border-l-[3px] border-l-emerald-400 rounded-lg border p-3"
        >
        ...
        <div
          use:reveal={{ delay: 180 }}
          class="reveal bg-surface2 border-border border-l-[3px] border-l-sky-400 rounded-lg border p-3"
        >
        ...
        <div
          ...
          class="reveal bg-surface2 border-border border-l-[3px] border-l-amber-400 rounded-lg border p-3"
        >
