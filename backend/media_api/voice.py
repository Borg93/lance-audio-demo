...
Thin HTTP layer over :mod:`backend.media_api.voice_service`: it resolves the
...
from backend.media_api import voice_service
...
if TYPE_CHECKING:
    ...
    from backend.media_api.wespeaker import VoiceEncoder
