...
:mod:`backend.search_api.encoders.embedding`: a bi-encoder embeds query and
...
from backend.search_api.encoders.base import DEFAULT_TIMEOUT_S, RerankResponse, VLLMTransport
