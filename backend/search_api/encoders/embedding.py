...
counterpart lives in :mod:`backend.search_api.encoders.reranker`.
"""
...
from backend.search_api.encoders.base import (
    DEFAULT_TIMEOUT_S,
    ChatMessage,
    EmbeddingResponse,
    ImagePart,
...
from backend.search_api.encoders.image import image_to_data_url, l2_normalize
